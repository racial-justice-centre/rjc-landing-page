      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="space-y-8 sm:space-y-12 lg:space-y-16">
          ...
          <div className="space-y-3 sm:space-y-4 lg:space-y-6 flex flex-col items-center">
            ...
            <Image src="/images/education/australian_hate_crime_reforms.png" alt="Human rights choked out by new hate crime laws" width={1000} height={1000} className="w-full max-w-4xl" />
