...
import { ADVISORY_BOARD, VOLUNTEERS } from "./data";
    ...
    return (<>
        ...
        <div className="space-y-16">
          <div className="space-y-4 flex flex-col items-center">
            ...
            Our Patrons, Governing Board And Advisor
            </h2>
        ...
        <div className="px-6 pb-16 pt-32 bg-[#D9F3DD]">
        ...
        <section className="bg-[#D9F3DD]">
        <div className="max-w-6xl mx-auto px-6 pb-16">
                <HoverAvatarGallery members={VOLUNTEERS} />
            </div>
        </section>
    </>)
}
